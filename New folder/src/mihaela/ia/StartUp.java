...
{  final float R =6371;//Earth`s radius in km
   ...
   final double a=Math.sin(differenceLatitude)*Math.sin(differenceLatitude)+Math.cos(latitudeA)*Math.cos(latitudeB)*Math.sin(differenceLongitude/2)*Math.sin(differenceLongitude/2);
